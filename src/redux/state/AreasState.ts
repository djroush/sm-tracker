...
export const defaultAreasState: AreaState[] = [
    ...
    { id: 1, value: 'CRATER', bgColor: '#1C29C3', itemIds: [], maxItems: 17},
    { id: 2, value: 'GR BRIN', bgColor: '#008800', itemIds: [], maxItems: 16},
    { id: 3, value: 'RED BRI', bgColor: '#B71A12', itemIds: [], maxItems: 5 },
    { id: 4, value: 'W MARID', bgColor: '#50C1A5', itemIds: [], maxItems: 7 },
    ...
    { id: 8, value: 'W SHIP', bgColor: '#D5C907', itemIds: [], maxItems: 11, bossId:0},
    { id: 9, value: 'E MARID', bgColor: '#B076FF', itemIds: [], maxItems: 11, bossId:0},
